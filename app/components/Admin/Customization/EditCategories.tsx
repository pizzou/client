...
const EditCategories = (props: Props) => {
  ...
  useEffect(() => {
    if (data && data.layout) {
      if (data.layout.categories) {
        ...
        setCategories([]); // Fallback in case categories is empty
        toast.error("Categories data is not available.");
      }
    } else {
      setCategories([]);
      toast.error("Layout data is not available. Please try again.");
    }
  ...
  const editCategoriesHandler = async () => {
    if (data && data.layout && data.layout.categories) {
      ...
      console.error("API Response: ", data); // Debug the API response
      toast.error("Categories data is not available. Please try again.");
    }
  };
